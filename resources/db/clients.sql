...
insert into clients (id, secret, info, redirects, scopes, grants, authorities, approved, created_at) values (:id, :secret, :info, :redirects, :scopes, :grants, :authorities, :approved, :created-at)
