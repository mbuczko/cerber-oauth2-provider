...
insert into users (id, login, email, name, password, authorities, enabled, created_at, activated_at) values (:id, :login, :email, :name, :password, :authorities, :enabled, :created-at, :activated-at)
